...
<div style="padding-top:2rem; padding-bottom: 5rem;" class="mx-auto p-16 sm:p-24 lg:p-48 bg-gray-200">
    ...
    <!--Modal-->
    <div class="modal opacity-0 pointer-events-none fixed w-full h-full inset-0.5 flex items-center justify-center" id="modal" style="z-index: 999;overflow: auto; width: 100%">
        <div class="modal-overlay absolute w-full h-full bg-gray-900 opacity-50"></div>
        <div class="modal-container bg-white w-11/12 h-4/5 md:max-w-6xl  mx-auto rounded shadow-lg z-50 overflow-y-auto" style="padding-top: 2rem; padding-bottom: 2rem;">
            <div class="modal-content py-4 text-left px-10">
                <div class="flex justify-between items-center pb-3 text-2xl font-bold text-center" id="judul">
                </div>
                <p class="p-3 text-center" id="isi"></p>
                <a href="" target="_blank" style="font-style: italic; color:blue" id="file">Silahkan Download Disini</a>
                <div class="grid grid-cols-2">
                    <div class="flex items-baseline mt-3 text-black-600">
                        <span>Author &nbsp;</span>
                        <span style="font-style: italic;" id="author"></span>
                    </div>
                </div>
            </div>
        </div>
