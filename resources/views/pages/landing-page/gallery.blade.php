...
<section class="mx-auto max-w-2xl">
    ...
    <div class="shadow-2xl relative">
        ...
        <div class="flex">
            <div>
                <img class="image1 description h-24 opacity-50 hover:opacity-100 cursor-pointer" src="{{ asset('/assets/img/picture16.png') }}" onclick="currentSlide(1)" alt="Dog's Nose">
            </div>
            <div>
                <img class="image2 description h-24 opacity-50 hover:opacity-100 cursor-pointer" src="{{ asset('/assets/img/picture16.png') }}" onclick="currentSlide(2)" alt="Lawnmower">
            </div>
            <div>
                <img class="image3 description h-24 opacity-50 hover:opacity-100 cursor-pointer" src="{{ asset('/assets/img/picture16.png') }}" onclick="currentSlide(3)" alt="Globe">
            </div>
            <div>
                <img class="image4 description h-24 opacity-50 hover:opacity-100 cursor-pointer" src="{{ asset('/assets/img/picture16.png') }}" onclick="currentSlide(4)" alt="Optical Illusion">
            </div>
            <div>
                <img class="image5 description h-24 opacity-50 hover:opacity-100 cursor-pointer" src="{{ asset('/assets/img/picture16.png') }}" onclick="currentSlide(5)" alt="Lips">
            </div>
        </div>
    </div>
</section>
