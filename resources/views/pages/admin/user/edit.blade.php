...
<div class="min-h-screen bg-gray-100 p-0 sm:p-12">
    <div class="mx-auto max-w-md px-6 py-12 bg-white border-0 shadow-lg sm:rounded-3xl">
        <h1 class="text-2xl font-bold mb-8" style="text-align: center;">Form Edit Admin</h1>
        <form method="post" id="form" novalidate action="/admin/user/update">
            @csrf
            <input type="hidden" name="id" value="{{$user->id}}">
            <div class="relative z-0 w-full mb-5">
                <input type="text" name="username" value="{{$user->username}}" placeholder=" " required class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
