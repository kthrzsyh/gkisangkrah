...
<header class="bg-white shadow">
    <div class="flex max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <a href="/admin/addGallery" class="btn bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded flex w-15">Tambah Gambar</a>
    </div>
</header>
<!-- table -->
    ...
    <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
            <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                <table class="min-w-full divide-y divide-gray-200" id="table-gallery">
                    <thead class="bg-gray-50">
                        <tr>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">No</th>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Gambar</th>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Deskripsi</th>
                            <th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Tanggal Upload</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200" style="text-align: center;">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <img style="height: 120px; align-content: center;" src="/gallery/{{$dataGallery->gambar}}" alt="">
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                {{$dataGallery->deskripsi}}
                            </td>
